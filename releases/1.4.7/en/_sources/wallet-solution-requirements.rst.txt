...
- .. _wia-time-to-live:
  ...
  The Wallet Instance Attestation MUST have a time-to-live of less than 24 hours: the difference between the expiration time (``exp``) and the issuance time (``iat``) MUST be less than 24 hours, after which it MUST no longer be considered valid (:ref:`WP_028 <wallet-instance-testcases>`, :ref:`WP_144 <wallet-instance-optional-testcases>`).

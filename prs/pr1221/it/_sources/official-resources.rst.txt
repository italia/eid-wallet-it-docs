...
- **IT-Wallet ID**: Elemento grafico ufficiale che assicura l’identificazione e rappresentazione univoca degli Attestati di identificazione personale (IT-Wallet ID / PID) tra tutte le Soluzioni Wallet - `Scarica IT-Wallet ID <_static/IT-Wallet-ID/IT-Wallet-ID-Primary-BlueItalia.svg>`_
...
- **IT-Wallet Presentation QR Code Page**: Template HTML/CSS/JS ufficiale e autoconsistente per la pagina QR del flusso remoto di presentazione OpenID4VP (**Cross Device**), con payload dimostrativo di Authorization Request tramite custom URL scheme (``openid4vp://`` o ``haip-vp://``, Request Object by reference, come descritto in :ref:`remote-flow:Flusso Remoto`). Le card della Selection Page puntano a questa demo basata sulla libreria `Bootstrap Italia <https://italia.github.io/bootstrap-italia/>`__ - `Vedi il template <https://github.com/italia/eid-wallet-it-docs/tree/versione-corrente/official_resources/it-wallet-presentation-qr-code-page>`__ - `Demo live <_static/it-wallet-presentation-qr-code-page/qr-code-page.html>`__

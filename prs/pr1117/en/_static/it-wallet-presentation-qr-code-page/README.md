...
Per verificare manualmente il payload in pagina (accordion e link cliccabile sul QR), aggiungere `debug=true` ai parametri URL, ad esempio:

```text
qr-code-page.html?wallet_id=it-wallet&debug=true
```

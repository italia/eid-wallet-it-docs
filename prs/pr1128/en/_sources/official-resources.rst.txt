...
- **Pages templates**: the models of the pages that belong to the Authentication flow: Discovery page, Selection page, QR code page, Thank you page and Error page  – Go to `Pages-templates/ <https://github.com/italia/eid-wallet-it-docs/tree/versione-corrente/official_resources/Pages-templates>`
- **Icons and pictograms**: icons and pictograms useful to implement the Authentication flow – `Download OK State <_static/official_resources/Icons-and-pictograms/OK_State.svg>`_ - `Download KO state <_static/official_resources/Icons-and-pictograms/KO_State.svg>`_ - `Download order <_static/official_resources/Icons-and-pictograms/Order.svg>`_

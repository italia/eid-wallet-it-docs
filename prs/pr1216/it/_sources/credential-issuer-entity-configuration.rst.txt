...
I Fornitori di Attestati Elettronici, in quanto Entità di Federazione, DEVONO rispettare le linee guida delineate nella Sezione :ref:`infrastructure-trust:Entity Configuration`. In particolare, DEVONO fornire un endpoint *well-known* che ospiti la loro Entity Configuration.
Quest'ultima DEVE contenere i parametri definiti nelle Sezioni :ref:`infrastructure-trust:Entity Configuration of a Leaf` e :ref:`infrastructure-trust:Entity Statement Parameters`.
...
I Metadata *federation_entity* DEVONO contenere i parametri come definiti nella Sezione :ref:`infrastructure-trust:Entity Type Identifiers and Metadata`.

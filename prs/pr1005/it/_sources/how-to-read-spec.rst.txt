...
* **Sezione** :ref:`Endpoint per flussi remoti della Relying Party <relying-party-remote-flow-endpoints-endpoint-per-flussi-remoti-della-relying-party>`: Specifiche API complete della Relying Party per flussi remoti e di prossimità.

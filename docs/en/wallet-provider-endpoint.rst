...
.. list-table::
    ...
    * - **cnf**
      ...
      - :rfc:`7800`.
    * - **vct**
      - REQUIRED. Credential type value MUST be an URN and it MUST be of the type ``urn:eudi:WalletAttestation:it:{version}`` as described in :ref:`registry:Digital Credentials Catalog`.

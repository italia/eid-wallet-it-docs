...
preferences and device's capabilities (:ref:`WP_025 <wallet-instance-testcases>`). Please refer to :ref:`wallet-attestation-issuance:Wallet Instance and Wallet Unit Attestation Issuance`.

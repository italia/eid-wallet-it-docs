...
All entities (Wallet Providers, Credential Issuers, Relying Parties) involved within the IT-Wallet ecosystem (hereinafter "Project Owners") **MUST** adhere to industry best practices to ensure the software is usable, compliant, and secure.

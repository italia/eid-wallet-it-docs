...
The button is available in 3 variants (default / M / L ) and in “get” (call to an external page) and “post” (form inside the button) formats. The system requires Jquery 1.8+. Below is the html code: 

...
The Credential Issuers, as Federation Entity, MUST adhere to the guidelines outlined in Section :ref:`trust-artifact-oidfed:Entity Configuration`. Specifically, they MUST provide a *well-known* endpoint that hosts their Entity Configuration.
The Entity Configuration of Credential Issuers MUST contain the parameters defined in the Sections :ref:`trust-artifact-oidfed:Entity Configuration of a Leaf` and :ref:`trust-artifact-oidfed:Entity Statement Parameters`.
...
The *federation_entity* metadata MUST contain the parameters as defined in Section :ref:`trust-artifact-oidfed:Entity Type Identifiers and Metadata`.

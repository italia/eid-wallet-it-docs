...
- *EUDIW Trust Framework*: WRPs are ``OPERATIONAL`` if they were ``REGISTERED`` and they obtained a WRPAC, the corresponding WRPRC(s), and, depending on the role, a Sign/Seal Certificate.

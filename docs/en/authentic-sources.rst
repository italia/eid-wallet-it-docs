...
Public Authentic Sources MUST interact with Credential Issuers via PDND according to the rules defined in Section :ref:`e-service-pdnd:e-Service PDND` and in Section :ref:`credential-revocation:Aggiornamento dello Stato da parte delle Fonti Autentiche`. See also Section :ref:`authentic-source-endpoint:Catalogo delle Fonti Autentiche e-Service PDND` for additional details.

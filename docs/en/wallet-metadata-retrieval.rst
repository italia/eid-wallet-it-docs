...
For doing so, the third parties offering the Credential Offer (e.g., Authentic Source, Registry, Catalogue) and the Relying Parties consult the IT-Wallet System Register, in particular the Federation Registry, via the Trust Anchor's endpoints.
...
and obtain the Wallet Solution metadata (see :ref:`wallet-provider-metadata:Wallet Provider Metadata`). More details on the use of the Trust Anchor's endpoints are provided in :ref:`trust-infrastructure:The Infrastructure of Trust`.

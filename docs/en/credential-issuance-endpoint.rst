...
.. list-table::
    ...
    * - **jti**
      ...
      - [:rfc:`7519`].
    * - **issuer_state**
      - It MUST be present in the Request Object when the Credential Offer contains ``issuer_state``. It MUST contain the same value contained in the Credential Offer. The format of that value is defined in :ref:`credential-issuance-low-level:issuer_state Parameter`.

...
For IT-Wallet ID issuance:
  ...
  * If the Authorization Server receives a hint that it supports and accepts, SHOULD omit presenting a discovery page and/or autonomously applying only its default authentication method.

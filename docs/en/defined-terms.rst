...
.. glossary::
    ...
    **Critical Asset**
      Asset (e.g., a cryptographic key) whose loss would seriously impact the Wallet Unit.
      Aligned with ARF 2.7.3.

    **Cryptographic Hardware Key Tag**
      Unique identifier for the Cryptographic Hardware Key, used to access the private key in hardware.
    ...
    **Primary Actor**
      Entity implementing Technical Solutions for the IT-Wallet System.
      Not present in ARF 2.7.3; specific to IT-Wallet.
    ...
    **Technical Specification**
      Specification providing technical architecture, implementation framework, and design requirements.
      Aligned with ARF 2.7.3.

...
- During issuance of a PID, the Wallet Unit SHALL provide the PID Provider with a valid Key Attestation (KA) describing the WSCA/WSCD that generated the new PID private key. Note: A PID private key is always generated and managed by the WSCA/WSCD, which by definition complies with requirements for Level of Assurance High.

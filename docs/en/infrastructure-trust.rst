...
This choice will affect both the onboarding and the trust evaluation procedures. If only the national boundary is requested, the infrastructure of trust complies with the National Trust Framework. Otherwise, the EUDIW Trust Framework is necessary.

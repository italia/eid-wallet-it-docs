...
- The Relying Party MUST register with the Federation Authority to obtain a Registration Certificate that explicitly authorizes which credential types and specific attributes may be requested.

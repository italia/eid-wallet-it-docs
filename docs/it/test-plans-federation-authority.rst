...
.. list-table::
  ...
  * - FA_005
    ...
    - Il payload contiene ``jwks`` e ``metadata`` con l'oggetto ``federation_entity`` che include gli endpoint della Federazione pubblicati come da :ref:`infrastructure-trust:Federation API Endpoints`.
  * - FA_006
    - Security

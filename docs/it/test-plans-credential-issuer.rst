...
.. list-table::
  ...
  * - CI_054
    ...
    - Il (Q)EAA Provider esegue con successo l’autenticazione dell’utente richiedendo e validando un PID valido dall’istanza del Wallet, oppure un IT-Wallet ID valido se il Credential Issuer così decide.
  * - CI_055
    - Presentazione, Emissione, Interoperabilità
    - Utilizzo del protocollo OpenID4VP
    - Il (Q)EAA Provider utilizza il protocollo OpenID4VP per richiedere la presentazione del PID dall’istanza del Wallet, oppure dell’IT-Wallet ID se il Credential Issuer così decide.
  * - CI_056

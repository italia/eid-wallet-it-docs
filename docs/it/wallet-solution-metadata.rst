...
.. list-table::
    ...
    * - ``wallet_metadata``
      - OBBLIGATORIO. Contiene i parametri relativi ai metadati del Wallet come definiti nella :ref:`Tabella dei parametri dei metadati del portafoglio <table_wallet_metadata_parameters>` (incluso ``response_modes_supported``, che DEVE essere ``["direct_post.jwt"]``) e seguenti due parametri

...
.. note::
    Riguardo al punto 4, la selezione del metodo di autenticazione DEVE restare in capo all'*Authorization Endpoint* del PID Provider, secondo :ref:`credential-issuance-endpoint:Selezione del Metodo di Autenticazione dell'Utente`.

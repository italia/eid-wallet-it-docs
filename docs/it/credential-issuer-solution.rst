...
.. note::
   Per le Fonti Autentiche pubbliche, un Fornitore di Attestati Elettronici DEVE utilizzare PDND secondo quanto definito nelle Sezioni :ref:`e-service-pdnd:e-Service PDND`, :ref:`credential-revocation:Aggiornamento dello Stato da parte delle Fonti Autentiche`, e :ref:`authentic-source-endpoint:Catalogo delle Fonti Autentiche e-Service PDND`.

...
- **Icone e pittogrammi**: icone e pittogrammi utili per l'implementazione del flusso di Autenticazione – `Scarica OK State <_static/official_resources/Icons-and-pictograms/OK_State.svg>`_ - `Scarica KO state <_static/official_resources/Icons-and-pictograms/KO_State.svg>`_ - `Scarica order <_static/official_resources/Icons-and-pictograms/Order.svg>`_

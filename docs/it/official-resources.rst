...
- **IT-Wallet ID**: Elemento grafico ufficiale che assicura l’identificazione e rappresentazione univoca dell’IT-Wallet ID (Attestato Elettronico di Dati di Identificazione Personale di ambito nazionale) tra tutte le Soluzioni Wallet - `Scarica IT-Wallet ID <_static/IT-Wallet-ID/IT-Wallet-ID-Primary-BlueItalia.svg>`_

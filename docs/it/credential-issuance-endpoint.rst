...
Per l'emissione di un IT-Wallet ID:
  ...
  * Se l'*Authorization Server* riceve un *hint* che supporta e accetta, DOVREBBE omettere la disposizione di una pagina di *discovery* e/o l'applicazione autonoma del solo metodo di autenticazione di *default*.

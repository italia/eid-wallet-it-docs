...
.. list-table::
    ...
    * - **iat**
      ...
      - :rfc:`9126` e :rfc:`7519`.
    * - **exp**
      - OBBLIGATORIO. Timestamp UNIX con il tempo di scadenza del JWT. La durata è specificata in :ref:`la durata della Wallet Instance Attestation <wia-time-to-live>`.

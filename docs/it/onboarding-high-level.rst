...
Questo percorso DEVE assicurare gli standard di qualità dei dati e stabilire audit trail per tutte le attività di fornitura dei dati.
...
Gli :term:`Intermediari di Relying Party <Intermediario di Relying Party>` seguono un processo di onboarding dedicato che conferisce loro sia lo status di Intermediario riconosciuto sia l'autorità di effettuare l'onboarding delle Relying Party affiliate per conto del Trust Anchor. Nel profilo implementativo descritto dalle presenti specifiche tecniche, un Intermediario di Relying Party è anche un'Entità Intermedia OpenID Federation (vedi la definizione di **Intermediario IT-Wallet**). Il processo comprende:
